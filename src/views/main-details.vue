<template>
		...
		<!-- episode-area -->
		<section class="episode-area episode-bg" style="background-image: url(&quot;img/bg/episode_bg.jpg&quot;);">
			<div class="container">
				<div class="row">
					<div class="col-lg-8">
		...
		<!-- tv-series-area -->
		<section class="tv-series-area tv-series-bg" style="background-image: url(&quot;img/bg/tv_series_bg02.jpg&quot;);">
			<div class="container">
